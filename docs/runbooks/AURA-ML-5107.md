# AURA-ML-5107 - The naturalness guard made an operation gentler, or withdrew a family
...
so a frame whose teeth could not be evened safely still gets its lint removed. ADR-0045 section 5.
