...
of phase 19, with 20, 21 and 22 not yet existing. Unlike phase 19 it consumes nothing that has
not shipped - its dependencies are phases 06, 11 and 14, and all three are here.
...
- **`GeometryService` is the only way to ask how a photograph's frame was finished.** Sixteenth
  service of its kind. Phase 27 checks these crops, phase 29 lays albums out of the variants and
